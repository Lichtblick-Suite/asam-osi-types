...
// index.ts
var asam_osi_types_exports = {};
__export(asam_osi_types_exports, {
  BoundingBox_Type: () => BoundingBox_Type,
  CameraDetection_Color: () => CameraDetection_Color,
  CameraDetection_ImageShapeType: () => CameraDetection_ImageShapeType,
  CameraSensorViewConfiguration_ChannelFormat: () => CameraSensorViewConfiguration_ChannelFormat,
  CameraSensorViewConfiguration_PixelOrder: () => CameraSensorViewConfiguration_PixelOrder,
  DetectedEntityHeader_DataQualifier: () => DetectedEntityHeader_DataQualifier,
  DetectedItemHeader_MeasurementState: () => DetectedItemHeader_MeasurementState,
  DetectedMovingObject_MovementState: () => DetectedMovingObject_MovementState,
  DetectedMovingObject_ReferencePoint: () => DetectedMovingObject_ReferencePoint,
  DetectedTrafficSign_DetectedMainSign_Geometry: () => DetectedTrafficSign_DetectedMainSign_Geometry,
  DetectionClassification: () => DetectionClassification,
  EnvironmentalConditions_AmbientIllumination: () => EnvironmentalConditions_AmbientIllumination,
  EnvironmentalConditions_CloudLayer_FractionalCloudCover: () => EnvironmentalConditions_CloudLayer_FractionalCloudCover,
  ...
  HostVehicleData_VehicleAutomatedDrivingFunction_DriverOverride_Reason: () => HostVehicleData_VehicleAutomatedDrivingFunction_DriverOverride_Reason,
  HostVehicleData_VehicleAutomatedDrivingFunction_Name: () => HostVehicleData_VehicleAutomatedDrivingFunction_Name,
  HostVehicleData_VehicleAutomatedDrivingFunction_State: () => HostVehicleData_VehicleAutomatedDrivingFunction_State,
  HostVehicleData_VehicleBasics_OperatingState: () => HostVehicleData_VehicleBasics_OperatingState,
  HostVehicleData_VehiclePowertrain_Motor_Type: () => HostVehicleData_VehiclePowertrain_Motor_Type,
  LaneBoundary_BoundaryPoint_Dash: () => LaneBoundary_BoundaryPoint_Dash,
  LaneBoundary_Classification_Color: () => LaneBoundary_Classification_Color,
  LaneBoundary_Classification_Type: () => LaneBoundary_Classification_Type,
  Lane_Classification_Subtype: () => Lane_Classification_Subtype,
  Lane_Classification_Type: () => Lane_Classification_Type,
  LogicalDetectionClassification: () => LogicalDetectionClassification,
  LogicalDetectionDataHeader_DataQualifier: () => LogicalDetectionDataHeader_DataQualifier,
  LogicalLaneBoundary_PassingRule: () => LogicalLaneBoundary_PassingRule,
  LogicalLane_MoveDirection: () => LogicalLane_MoveDirection,
  LogicalLane_TrafficRule_TrafficRuleType: () => LogicalLane_TrafficRule_TrafficRuleType,
  LogicalLane_Type: () => LogicalLane_Type,
  MotionRequest_MotionRequestType: () => MotionRequest_MotionRequestType,
  MovingObject_PedestrianAttributes_Bone_Type: () => MovingObject_PedestrianAttributes_Bone_Type,
  MovingObject_Type: () => MovingObject_Type,
  MovingObject_VehicleClassification_LightState_BrakeLightState: () => MovingObject_VehicleClassification_LightState_BrakeLightState,
  MovingObject_VehicleClassification_LightState_GenericLightState: () => MovingObject_VehicleClassification_LightState_GenericLightState,
  MovingObject_VehicleClassification_LightState_IndicatorState: () => MovingObject_VehicleClassification_LightState_IndicatorState,
  MovingObject_VehicleClassification_Role: () => MovingObject_VehicleClassification_Role,
  MovingObject_VehicleClassification_Type: () => MovingObject_VehicleClassification_Type,
  Occupant_Classification_Seat: () => Occupant_Classification_Seat,
  Occupant_Classification_SteeringControl: () => Occupant_Classification_SteeringControl,
  ReferenceLine_Type: () => ReferenceLine_Type,
  RoadMarking_Classification_Color: () => RoadMarking_Classification_Color,
  RoadMarking_Classification_Type: () => RoadMarking_Classification_Type,
  SensorDetectionHeader_DataQualifier: () => SensorDetectionHeader_DataQualifier,
  SensorDetectionHeader_ExtendedQualifier: () => SensorDetectionHeader_ExtendedQualifier,
  StationaryObject_Classification_Color: () => StationaryObject_Classification_Color,
  StationaryObject_Classification_Density: () => StationaryObject_Classification_Density,
  StationaryObject_Classification_Material: () => StationaryObject_Classification_Material,
  StationaryObject_Classification_Type: () => StationaryObject_Classification_Type,
  TrafficAction_DynamicsShape: () => TrafficAction_DynamicsShape,
  TrafficAction_FollowingMode: () => TrafficAction_FollowingMode,
  TrafficLight_Classification_Color: () => TrafficLight_Classification_Color,
  TrafficLight_Classification_Icon: () => TrafficLight_Classification_Icon,
  TrafficLight_Classification_Mode: () => TrafficLight_Classification_Mode,
  TrafficSignValue_Unit: () => TrafficSignValue_Unit,
  TrafficSign_MainSign_Classification_DirectionScope: () => TrafficSign_MainSign_Classification_DirectionScope,
  TrafficSign_MainSign_Classification_Type: () => TrafficSign_MainSign_Classification_Type,
  TrafficSign_SupplementarySign_Classification_Actor: () => TrafficSign_SupplementarySign_Classification_Actor,
  TrafficSign_SupplementarySign_Classification_Arrow_Direction: () => TrafficSign_SupplementarySign_Classification_Arrow_Direction,
  TrafficSign_SupplementarySign_Classification_Type: () => TrafficSign_SupplementarySign_Classification_Type,
  TrafficSign_Variability: () => TrafficSign_Variability,
  UltrasonicSpecificObjectData_Trend: () => UltrasonicSpecificObjectData_Trend,
  UltrasonicSpecificObjectData_TrilaterationStatus: () => UltrasonicSpecificObjectData_TrilaterationStatus
});
module.exports = __toCommonJS(asam_osi_types_exports);
